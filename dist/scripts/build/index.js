        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(activeApp.type === 'react')) return [3 /*break*/, 2];
                    return [4 /*yield*/, react_1.default(activeApp)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 7];
                case 2:
                    if (!(activeApp.type === 'node')) return [3 /*break*/, 4];
                ...
                case 4:
                    if (!(activeApp.type === 'js-package' ||
                        activeApp.type === 'react-component')) return [3 /*break*/, 6];
                    return [4 /*yield*/, packages_1.default(activeApp)];
                case 5:
                    _a.sent();
                    return [3 /*break*/, 7];
                case 6:
